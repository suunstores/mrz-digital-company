(() => {
  ...
  function publicMedia(product) {
    ...
    if (mediaUrl) {
      return `<img src="${escapeHtml(mediaUrl)}" alt="${escapeHtml(name)}" onerror="this.style.display='none';this.nextElementSibling.style.display='grid'">
